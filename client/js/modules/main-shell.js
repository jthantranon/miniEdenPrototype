...
EDEN.MainShell = (function(){
    ...
    m.print("&nbsp;Version 1.4 Beta",'lime',false);
//    m.print("&nbsp;LOGIN INTERFACE AVAILABLE FOR MOBILE AND THOSE ADVERSE TO THE COMMAND LINE. CLICK <a href='' ng-click='toggleLoginUI()'>{{loginUIToggle}}</a>.",'red',false);
    m.print("&nbsp;",'red',false);
